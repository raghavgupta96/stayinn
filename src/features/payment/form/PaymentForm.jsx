...
const paymentForm = props => {
  const { traveler, card, handlers } = props;
      ...
      <form>
        <section className="TravelerInformation">
          ...
          <TextField
            ...
            onChange={event =>
              handlers.setTraveler({ ...traveler, email: event.target.value })
            }
          />
          <TextField
            id="phonenumber"
        ...
        <section className="PaymentInformation">
          ...
          <TextField
            ...
            value={card.cardname}
            onChange={event =>
              handlers.setCard({ ...card, cardname: event.target.value })
            }
          />
          <TextField
            id="cardnumber"
            ...
            onChange={event =>
              handlers.setCard({ ...card, cardnumber: event.target.value })
            }
          />
          <TextField
            id="cvc"
            ...
            value={card.cvc}
            onChange={event =>
              handlers.setCard({ ...card, cvc: event.target.value })
            }
          />
          <Select>
            value=
